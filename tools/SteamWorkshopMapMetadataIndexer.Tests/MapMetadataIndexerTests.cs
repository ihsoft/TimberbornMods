  ...
  static void PreservesCanyonMapBaselines() {
    ...
    var expected = new Dictionary<string, (double Length, double Width, double BankHeight)[]>() {
      ["3-canyon-3702980793.json.gz"] = [
          (285.1, 18.4, 16), (160.3, 19.4, 16), (140.8, 18.5, 16),
      ...
      ["checkmate-3668003195.json.gz"] = [],
      ["clearwater-canyon-3683639237.json.gz"] = [
          (95.7, 3.2, 8), (47, 3.6, 8), (42.4, 3.2, 10),
      ],
      ...
      ["three-layer-canyons-3745388025.json.gz"] = [
          (105.2, 8, 8), (97.1, 5, 8), (76.9, 8, 9), (76.2, 6.5, 7),
          (67.4, 4.3, 7), (57.1, 9.3, 7), (56.7, 7.5, 11), (51.4, 5.6, 3),
          (51.1, 4.7, 7), (49.7, 8.5, 10), (43.9, 5.7, 7), (41.5, 5.1, 7),
      ],
