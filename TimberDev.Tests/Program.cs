...
static class Program {
  static readonly List<(string Name, Action Test)> Tests = [
      ...
      ("AbstractDialog confirms valid input", AbstractDialogTests.ShowWiresButtonsAndConfirmAppliesValidInput),
      ("AbstractDialog keeps open on error", AbstractDialogTests.ConfirmShowsErrorAndKeepsDialogOpen),
      ("AbstractDialog handles cancel", AbstractDialogTests.CancelClosesOrConfirmsUnsavedChanges),
      ...
      ("BaseSettings runs callbacks", BaseSettingsTests.RunsCallbacksOnLoadAndValueChange),
      ("DebugSettings exposes metadata", DebugSettingsTests.ExposesSettingsMetadata),
      ("DebugSettings updates verbosity", DebugSettingsTests.UpdatesVerbosityOnLoadAndValueChange),
