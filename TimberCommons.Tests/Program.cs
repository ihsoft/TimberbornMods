...
static class Program {
  static readonly List<(string Name, Action Test)> Tests = [
      ...
      ("DailyInjuryCounter moves current injuries to yesterday on next day",
          DailyInjuryCounterTests.MovesCurrentInjuriesToYesterdayOnNextDay),
      ("DailyInjuryCounter clears yesterday after skipped day",
