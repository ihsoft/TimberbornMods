...
sealed class WalkerPoweredGeneratorSettings : BaseSettings<WalkerPoweredGeneratorSettings> {

  const string HeaderStringLocKey = "IgorZ.SmartPower.Settings.WalkerPoweredGeneratorSection";
  ...
  public ModSetting<int> SuspendDelayMinutesInternal { get; } =
      new RangeIntModSetting(30, 0, 120, ModSettingDescriptor.CreateLocalized(SuspendDelayMinutesLocKey));

  public static int ResumeDelayMinutes { get; private set; }
  public ModSetting<int> ResumeDelayMinutesInternal { get; } =
      new RangeIntModSetting(15, 0, 120, ModSettingDescriptor.CreateLocalized(ResumeDelayMinutesLocKey));
