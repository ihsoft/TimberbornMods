...
sealed class WaterValveFragment : IEntityPanelFragment {
  ...
  const string MoveContaminatedWater = "Move contaminated water";
  ...
  Toggle _moveContaminatedWaterCheckCheckbox;
  ...
  public VisualElement InitializeFragment() {
    ...
    _moveContaminatedWaterCheckCheckbox = _builder.Presets().Toggles()
        .CheckmarkInverted(text: MoveContaminatedWater, color: UiFactory.PanelNormalColor);
    _moveContaminatedWaterCheckCheckbox.RegisterValueChangedCallback(
        _ => _waterValve.MoveContaminatedWater = _moveContaminatedWaterCheckCheckbox.value);
    _moveContaminatedWaterCheckCheckbox.style.marginBottom = 5;
    ...
    _root = _builder.CreateFragmentBuilder()
        ...
        .AddComponent(_moveContaminatedWaterCheckCheckbox)
  ...
  public void ShowFragment(BaseComponent entity) {
    ...
    if (_waterValve != null) {
      ...
      _moveContaminatedWaterCheckCheckbox.SetValueWithoutNotify(_waterValve.MoveContaminatedWater);
      _moveContaminatedWaterCheckCheckbox.ToggleDisplayStyle(visible: _devModeManager.Enabled);
