...
* [Feature] Find Workshop maps by keywords, forest density, water form, available settlement space, islands, and canyons, then subscribe from search results or map details without restarting the game.
...
* [Fix] Water-covered search recognizes dominant connected water surfaces even when a narrow land rim separates them from the map boundary.
