...
Before export, resolve the package owner and lane, satisfy applicable bootstrap and import readiness, close an
interactive Editor using the same project, and inspect the current `tools/export-unity-mod.ps1` parameters. Use
